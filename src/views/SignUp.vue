<template>
    <div class="flex items-start md:h-screen py-6 md:py-0 bg-brand25 justify-center md:px-32 relative">
        <img :src="background" class="hidden md:block w-full" />
        <div class="md:absolute top-6 h-fit md:w-5/12 w-11/12 md:mx-0 md:pb-10 pb-8 opacity-90 bg-white md:py-12 py-6 rounded-lg shadow-2xl">
            <div class="mb-3">
                <h1 class="text-center font-black md:text-3xl text-lg">Lets get started</h1>
                <p class="font-normal text-brand text-center md:text-sm text-xs">Create a new account</p>
            </div>
            <form class="space-y-6" @submit.prevent="sendEmail" method="POST">
                ...
                <div class="flex md:flex-row flex-col justify-evenly items-center w-full px-6 md:px-0 space-y-5 md:space-y-0">
                    <div class="flex flex-col md:w-2/5 w-full relative">
                        ...
                        />
                        <p
                            class="font-bold text-red-500 absolute -bottom-4"
                            style="font-size: 11px"
                            v-show="phone_number.length !== 11 && phone_number"
                        >
                            Phone number must be 11 digits
                        </p>
                    </div>
                    <div class="flex flex-col md:w-2/5 w-full relative">
                        <label for="phone_number" class="mb-0.5 ml-2 text-sm">Confirm Phone Number: *</label>
                        <input
                            type="tel"
                            maxlength="11"
                        ...
                        />
                        <p
                            class="text-red-500 absolute font-bold -bottom-4"
                            style="font-size: 11px"
                            v-show="phone_number !== confirm_phone_number && confirm_phone_number"
                        >
                            Confirm phone number does not match
                        </p>
                    </div>
                </div>
                <div class="flex md:flex-row md:flex-wrap items-start flex-col justify-evenly w-full px-6 md:px-0 space-y-5 md:space-y-0">
                    <div class="flex flex-col md:w-2/5 md:mb-6 w-full">
                        <label for="services_you_are_interested_in" class="mb-0.5 ml-2 text-sm">Services you are interested in? *</label>
                        <select
                            ...
                            class="bg-white rounded-xs h-10 md:text-base text-xs shadow-lg px-2 py-1 border border-brand"
                        >
                            <option value="default" class disabled>Services you are interested in?</option>
                    ...
                    <div class="flex flex-col md:w-2/5 md:mb-6 w-full">
                        <label for="services_you_are_interested_in" class="mb-0.5 ml-2 text-sm">{{
                    ...
                    <div class="flex flex-col md:w-2/5 md:pb-6 w-full">
                        <label for="repayment_duration" class="mb-0.5 ml-2 text-sm">Repayment Duration: *</label>
                        <select
                    ...
                    <div class="flex flex-col md:w-2/5 md:mb-6 w-full">
                        <label for="repayment_plan" class="mb-0.5 ml-2 text-sm">Repayment Plan: *</label>
                        <select
                            name="repayment_plan"
                    ...
                    <div class="flex flex-col md:w-2/5 md:mb-6 w-full">
                        ...
                        >
                            ...
                            <option class="text-sm" v-for="branch in areas" :key="branch.value" :value="branch.value">
                                {{ branch.name }}
                            </option>
                        </select>
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            loans: [{ details: "70,000 - 80,000" }, { details: "80,000 - 100,000" }, { details: "100,000 - 120,000" }],
            rents: [{ details: "100,000 - 200,000" }, { details: "200,000 - 300,000" }, { details: "300,000 - 500,000" }],
            products: [
                { details: "Phones" },
                { details: "Fridge" },
                { details: "Television" },
    ...
    methods: {
        ...
        sendEmail() {
            ...
            api.post(this.formURL, this.formData, true)
                .then(() => {
                    this.full_name = "";
                    this.phone_number = "";
