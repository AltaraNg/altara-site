<template>
    <main class="flex items-center w-full flex-col rounded shadow-lg hover:shadow-2xl cursor-pointer p-3">
            ...
            <div class="w-2/3 ml-4">
                ...
                <div class="w-full flex items-start flex-col">
                    <label class="toggle">
                        ...
                        <span class="text-gray-600 md:text-sm text-xs font-normal ml-4">Bi-Monthly</span>
                    </label>
                    ...
                    <div class="flex items-center w-full">
                        <p class="text-gray-700 font-semibold text-xs px-0.5">{{ biMonthly ? "Bi-monthly" : "Monthly" }} Repayment:&#160;</p>
                        <p class="font-black text-black">{{ biMonthly ? biMonthly_repayment : repayment }}</p>
                    </div>
                    <router-link :to="{ name: 'signup' }" class="flex items-center justify-center">
                        <button class="bg-brand mt-2 cursor-pointer text-xs rounded px-3 py-1 text-white font-bold" @click="sendToLocalStorage">
                            Get Started
                        </button>
                    </router-link>
                </div>
